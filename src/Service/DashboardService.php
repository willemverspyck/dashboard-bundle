...
use Spyck\DashboardBundle\Widget\DateParameterInterface;
use Spyck\DashboardBundle\Widget\DayRangeParameter;
use Spyck\DashboardBundle\Widget\EntityParameterInterface;
use Spyck\DashboardBundle\Widget\MonthRangeParameter;
use Spyck\DashboardBundle\Widget\ParameterInterface;
use Spyck\DashboardBundle\Widget\RequestInterface;
use Spyck\DashboardBundle\Widget\WeekRangeParameter;
use Exception;
use ReflectionClass;
